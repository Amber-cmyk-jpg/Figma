...
const Navbar = () => {
    ...
    return (
        <nav className={`fixed w-full z-50 transition-all duration-300 ${isVisible ? 'translate-y-0' : '-translate-y-full'} ${isScrolled ? 'bg-white/95 backdrop-blur-md shadow-sm' : 'bg-white'} border-b border-gray-100`}>
            <div className="max-w-7xl mx-auto px-6 lg:px-10">
                <div className="flex items-center justify-between h-16">
                    ...
                    {/* Centered Logo */}
<div
    className="flex items-center justify-center flex-shrink-0 mx-8 cursor-pointer select-none gap-2"
    onMouseEnter={() => setLogoHovered(true)}
    onMouseLeave={() => setLogoHovered(false)}
>
    {/* Teal circle ring icon */}
    <div
        style={{
            width: '25px',
            height: '26px',
            borderRadius: '50%',
            border: '5px solid #0CBBC7',
            flexShrink: 0,
        }}
    />
    {/* Wordmark */}
