        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          >
            ...
            >
              ...
              <span style={{ fontWeight: 400 }}> built for people.</span>
            </h2>
          ...
          >
            {/* The actual image */}
            <div className="relative z-10 rounded-2xl overflow-hidden shadow-2xl border border-gray-100 bg-gray-100">
              <img 
                src={featureImage} 
                alt="Features" 
                style={{
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] bg-accent-peach/20 rounded-full blur-3xl -z-10"></div>
          </motion.div>
